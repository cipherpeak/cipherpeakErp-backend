...
urlpatterns = [
    ...
    path('vehicle-report-details/', UserReportedVehicleIssuesAPIView.as_view(), name='vehicle-report-details'),
    path('create-temporary-vehicle/', CreateTemporaryVehicleAPIView.as_view(), name='create-temporary-vehicle'),
    path('report-issue/', ReportIssueCreateAPIView.as_view(), name='report-issue'),
